...
describe('Calculator', () => {
   ...
   * they have been included because they will quickly alert of any unexpected changes to a rendered component. 
  ...
  */
  ...
  it('should render the Display and Keypad Components', () => {
    ...
    /**
     * '.containsAllMatchingElements' takes an array of elements 
     * and returns true if all elements are found in the DOM tree.
    */    
    expect(wrapper.containsAllMatchingElements([

      /* 
        wrapper.instance() returns a single node for class components
        and returns null for stateless functional components
      */
      <Display displayValue={wrapper.instance().state.displayValue} />,
      <Keypad
